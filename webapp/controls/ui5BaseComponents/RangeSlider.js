 ...
 */
sap.ui.define(["./Slider", "sap/m/Input", 'sap/ui/core/InvisibleText'],
	function (Slider, Input, InvisibleText) {
         ...
         */
		var RangeSlider = Slider.extend("root.controls.ui5BaseComponents.RangeSlider", /** @lends sap.m.RangeSlider.prototype */ {
			metadata: {
				library: "sap.m",
				properties: {
                    /**
